...
<div id="page-wrapper"><div id="page">
   ...
   <!-- Page Header -->
  <header class="animated fadeIn navbar navbar-default <?php if ($hide_site_name && $hide_site_slogan && !$logo && !$main_menu && !$secondary_menu) { print ' element-invisible'; } ?>">
...
<aside class="clearfix">
      ...
      <nav class="collapse navbar-collapse <?php if (!$main_menu && !$secondary_menu) { print 'element-invisible'; } ?>" role="navigation">
        ...
        <?php
		  print render_block_content('superfish', '1');
		?>
		
		        <?php
		  print render_block_content('custom_search_blocks', '1');
		?>
       

        <?php
		  print render_block_content('locale', 'language');
		?>
        ...
        <?php print theme('links__system_secondary_menu', array(
          ...
          'heading' => array(
            ...
            'class' => array('element-invisible'),
        		        ...
        		        <?php
		  print render_block_content('crumbs', 'breadcrumb');
		?>
...
<footer id="footer">
	  	<div class="container">
		  	<div class="row">
			  	<div class="col-md-12">
				  	<?php
						  print render_block_content('menu', 'menu-footer-menu');
						?>
						<div class="siteby"><a href="http://answermen.com" title="Answermen Ltd." target="_blank">Site by Answermen</a></div>
			  	</div>
		  	</div>
	  	</div>
  	</footer>